const Container = () => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    time: time
  }), /*#__PURE__*/React.createElement(DigitalClock, {
    time: time
  }));
};
...
const DigitalClock = props => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: style_div1
  }, isZero(hour)), /*#__PURE__*/React.createElement("div", {
    style: {
      margin: '10px',
      color: '#04fc43'
    }
    ...
    style: style_div2
  }, isZero(minute)), /*#__PURE__*/React.createElement("div", {
    style: {
      margin: '10px',
      color: '#04fc43'
    }
...
const Clock = props => {
  ...
  const circle1 = { ...circle_i,
    ...circle_i1
  };
  const circle2 = { ...circle_i,
    ...circle_i2
  };
  const circle3 = { ...circle_i,
    ...circle_i3
  };
  ...
  let createArr = () => {
    ...
    const numbers = (elem, index, arr) => {
      ...
      return /*#__PURE__*/React.createElement("b", {
        ...
        style: { ...style_clock,
          ...{
            transform: 'rotateZ(' + elem + 'deg)',
            opacity: dateNew.getSeconds() - 1 < new Date().getSeconds() ? 1 : 0.06
          }
        }
      }, dateNew.getSeconds());
    };
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: circle1
  }), createArr()), /*#__PURE__*/React.createElement("div", {
  ...
  }, props.time.getMinutes())), /*#__PURE__*/React.createElement("div", {
  ...
  }, props.time.getHours())), /*#__PURE__*/React.createElement("div", null, nums.map(map)));
};
